...
_row "  --cloud-provider-color=N" "256-color number (0-255) for a custom --cloud-provider"
_row "  --server-type=X"      "skip that --server prompt, set it non-interactively instead"
_row "  --server-type-color=N" "256-color number (0-255) for a custom --server-type"
